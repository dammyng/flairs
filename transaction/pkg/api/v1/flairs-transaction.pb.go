...
var file_flairs_transaction_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x32, 0x96, 0x06, 0x0a, 0x18, 0x46, 0x6c, 0x61, 0x69, 0x72, 0x73, 0x54, 0x72, 0x61,
	...
	0x49, 0x64, 0x7d, 0x12, 0x68, 0x0a, 0x11, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x46,
	0x74, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x12, 0x15, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x66,
	0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x14, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x52, 0x65, 0x73,
	...
	0x66, 0x74, 0x2f, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x6c, 0x0a,
	0x16, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x54,
	0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x12, 0x13, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x72, 0x61,
	0x6e, 0x73, 0x66, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x76,
	...
	0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x74, 0x77, 0x2f,
	0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x3a, 0x01, 0x2a, 0x42, 0xca, 0x02, 0x92, 0x41,
	0xc6, 0x02, 0x12, 0x6a, 0x0a, 0x0e, 0x46, 0x6c, 0x61, 0x69, 0x72, 0x73, 0x20, 0x73, 0x65, 0x72,
	...
	0x6f, 0x6e, 0x20, 0x02, 0x62, 0x12, 0x0a, 0x10, 0x0a, 0x0c, 0x66, 0x6c, 0x61, 0x69, 0x72, 0x73,
	0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x00, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_flairs_transaction_proto_depIdxs = []int32{
	...
	13, // 10: v1.FlairsTransactionService.TransactFtDeposit:input_type -> v1.TfDepositeRequest
	...
	15, // 17: v1.FlairsTransactionService.TransactFtDeposit:output_type -> v1.TransactResponse
...
type FlairsTransactionServiceClient interface {
	...
	// Get wallets beloging to a particular user
	TransactFtDeposit(ctx context.Context, in *TfDepositeRequest, opts ...grpc.CallOption) (*TransactResponse, error)
	// Get wallets beloging to a particular user
...
func (c *flairsTransactionServiceClient) TransactFtDeposit(ctx context.Context, in *TfDepositeRequest, opts ...grpc.CallOption) (*TransactResponse, error) {
	out := new(TransactResponse)
	err := c.cc.Invoke(ctx, "/v1.FlairsTransactionService/TransactFtDeposit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FlairsTransactionServiceServer interface {
	...
	// Get wallets beloging to a particular user
	TransactFtDeposit(context.Context, *TfDepositeRequest) (*TransactResponse, error)
	// Get wallets beloging to a particular user
...
func (*UnimplementedFlairsTransactionServiceServer) TransactFtDeposit(context.Context, *TfDepositeRequest) (*TransactResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TransactFtDeposit not implemented")
}
...
func _FlairsTransactionService_TransactFtDeposit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TfDepositeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FlairsTransactionServiceServer).TransactFtDeposit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.FlairsTransactionService/TransactFtDeposit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FlairsTransactionServiceServer).TransactFtDeposit(ctx, req.(*TfDepositeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FlairsTransactionService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TransactFtDeposit",
			Handler:    _FlairsTransactionService_TransactFtDeposit_Handler,
		},
		{
