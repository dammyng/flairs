...
/*
Package wallet_v1 is a reverse proxy.
...
var (
	pattern_WalletService_AddNewWallet_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "wallet", "new", "type"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_WalletService_GetWallet_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "wallets", "walletId"}, "", runtime.AssumeColonVerbOpt(true)))
)
