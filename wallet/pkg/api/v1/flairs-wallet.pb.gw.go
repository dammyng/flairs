...
var (
	...
	pattern_WalletService_GetMyWallets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"v1", "userId", "wallets"}, "", runtime.AssumeColonVerbOpt(true)))
